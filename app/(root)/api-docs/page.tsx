...
type JobCardColor = 'purple' | 'teal' | 'yellow' | 'red';

function JobCard({ icon, title, trigger, desc, color }: { icon: React.ReactNode; title: string; trigger: string; desc: string; color: JobCardColor }) {
  const colorClasses: Record<JobCardColor, string> = {
