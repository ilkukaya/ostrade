...
type FeatureCardColor = 'blue' | 'purple' | 'red';

function FeatureCard({ icon, title, desc, color }: { icon: React.ReactNode; title: string; desc: string; color: FeatureCardColor }) {
    const borders: Record<FeatureCardColor, string> = {
